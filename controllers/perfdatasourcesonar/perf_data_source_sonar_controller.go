...
import (
	...
	"github.com/epam/edp-perf-operator/v2/controllers/perfdatasourcesonar/chain"
...
//+kubebuilder:rbac:groups=v2.edp.epam.com,namespace=placeholder,resources=perfdatasourcesonars,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=v2.edp.epam.com,namespace=placeholder,resources=perfdatasourcesonars/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=v2.edp.epam.com,namespace=placeholder,resources=perfdatasourcesonars/finalizers,verbs=update
