...
import (
	...
	"github.com/epam/edp-perf-operator/v2/controllers/perfdatasourcegitlab/chain"
...
//+kubebuilder:rbac:groups=v2.edp.epam.com,namespace=placeholder,resources=perfdatasourcegitlabs,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=v2.edp.epam.com,namespace=placeholder,resources=perfdatasourcegitlabs/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=v2.edp.epam.com,namespace=placeholder,resources=perfdatasourcegitlabs/finalizers,verbs=update
