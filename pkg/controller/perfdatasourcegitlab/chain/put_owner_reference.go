...
func (h PutOwnerReference) ServeRequest(ds *v1alpha1.PerfDataSourceGitLab) error {
...
func (h PutOwnerReference) setPerfOwnerRef(ds *v1alpha1.PerfDataSourceGitLab) error {
